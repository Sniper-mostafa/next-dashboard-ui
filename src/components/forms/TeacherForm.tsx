...
const schema = z.object({
  username: z
    .string()
    .min(3, { message: "Username must be at least 3 long!" })
  ...
  address: z.string().min(1, { message: "Phone is required!" }),
  bloodType: z.string().min(1, { message: "Blood Type is required!" }),
  birthday: z.string().min(1, { message: "Phone is required!" }),
  sex: z.enum(["male", "female"], { message: "Phone is required!" }),
